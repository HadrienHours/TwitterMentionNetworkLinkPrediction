...
#    plt.figure(figsize=(6, 8))
    ...
    #ax3 = ax_main.twinx()
    ax_main.plot(range(len(listoverlaps1)),listoverlap_mention,'r--',lw=1.5,marker='*',markersize=10,label='Hashtag similarity mention neighbors')
    ax_main.plot(range(len(listoverlaps1)),listoverlap_random,'b--',lw=1.5,marker='.',markersize=12,label='Hashtag similarity random nodes')
